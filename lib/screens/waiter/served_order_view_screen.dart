...
import './served_orders_screen.dart';

class WaiterServedOrderViewScreen extends StatelessWidget {
  static const routeName = '/waiter/served-order-view';

  closeOrder(orderId, context) async {
    try {
      ...
      await Provider.of<Orders>(context, listen: false)
          .updateOrderStatus(orderId, kOrderStatusTypes['Closed']);
